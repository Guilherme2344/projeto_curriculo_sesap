...
- O IP (formato IPv4) armmazenado no banco de dados sempre será "127.0.0.1" caso o programa esteja rodando localmente. Para que o programa pegue o IP real do dispositivo, o site terá que ser publicado na internet
